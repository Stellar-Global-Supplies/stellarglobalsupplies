...
-- ─────────────────────────────────────────────────────────────────────────────
-- Meta Analytics Cache — stores Instagram, Facebook, and Ads insights
-- Table name starts with "observe" as per requirements
-- ─────────────────────────────────────────────────────────────────────────────
create table public.observe_meta_analytics_cache (
...
create index observe_meta_analytics_period_idx on public.observe_meta_analytics_cache (period);
create index observe_meta_analytics_cached_at_idx on public.observe_meta_analytics_cache (cached_at desc);

alter table public.observe_meta_analytics_cache enable row level security;

create policy "Authenticated users can read meta analytics cache" on public.observe_meta_analytics_cache
for select to authenticated using (true);

create policy "Service role can insert meta analytics cache" on public.observe_meta_analytics_cache
